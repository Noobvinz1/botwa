...
/////////////////
const BotName = 'NOOBVINZBOT☄'; 
const instagram = 'https://instagram.com/noob.vinz'; 
const telegram = 'https://t.me/Vinzzz'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/noobvinz';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by yt:Noobvinz`)
})
